...
class BackPropagation(nn.Module):
    def __init__(
        ...
        self.register_buffer("epsilon", torch.zeros(2, num_nodes))
    ...
    def r2i(
        ...
        r_i_delta = scatter(r_i_delta, dst, reduce="sum")
    ...
    def i2s(
        ...
        i_s_delta = scatter(i_s_delta, dst, reduce="sum")
...
def main(
    ...
    for name in file_list:
        for type_ in type_list:
            ...
            save_history_csv(agg, f"{history_dir}/wo_epsilon_{name}_{type_}.csv")
    ...
    save_csv(results, "result/wo_epsilon.csv")
